...
sudo pacman -S evince atom base-devel nemo nemo-fileroller nemo-preview r \
    ...
    gcc-fortran transmission-gtk conky kitty ttf-font-awesome \
...
yay -S google-chrome rstudio-desktop-bin srm dropbox nemo-dropbox overgrive \
...
cd $current_dir
yay -S gnome-perl perl-gnome2-wnck perl-goo-canvas perl-gtk2-imageview \
